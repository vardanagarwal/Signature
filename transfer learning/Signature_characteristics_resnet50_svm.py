...
for folders in range(0,100):
    ...
    vgg16_feature_list = []
    labels = []
    model_vgg19 = VGG19(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000)
    ...
    for imagePath in paths.list_images(training):
        ...
        vgg16_feature = model_vgg19.predict(img_data)
